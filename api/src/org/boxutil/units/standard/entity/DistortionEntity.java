...
public class DistortionEntity extends BaseInstanceRenderData implements DirectDrawEntity {
    ...
    public void submitEntityData() {
        this.statePackageBuffer.put(0, this.sizeState_A, 0, 12);
        this.statePackageBuffer.put(12, this.sizeState_B, 0, 7);
        this.statePackageBuffer.put(19, this.haveValidInstanceData() ? this.getInstanceTimerOverride() : this.globalTimer[0]);
        this.statePackageBuffer.put(20, this.state_C, 0, 4);
    ...
    public FloatBuffer pickDataPackage_vec4() {
        ...
        else this.statePackageBuffer.put(19, this.haveValidInstanceData() ? this.getInstanceTimerOverride() : this.globalTimer[0]);
