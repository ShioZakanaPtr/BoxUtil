...
public class Instance2Data implements InstanceDataAPI {
    ...
    protected float turnRate = 0.0f;
    protected float alphaFixed = 2.0f;
    protected final float[] location = new float[2];
    protected final float[] scale = new float[2];
    protected final float[] velocity = new float[2];
    protected final float[] scaleRate = new float[2];
    ...
    public float[] _pickDynamic_ssbo() {
        return new float[]{
                this.facing, this.turnRate,
                this.location[0], this.location[1], this.scale[0], this.scale[1],
                this.velocity[0], this.velocity[1], this.scaleRate[0], this.scaleRate[1],
    ...
    public float[] _pickFixed_ssbo() {
        return new float[]{
                this.alphaFixed, this.facing, this.location[0], this.location[1],
    ...
    public Vector2f getLocation() {
        return new Vector2f(this.location[0], this.location[1]);
    }
    ...
    public float[] getLocationArrayDirect() {
        return new float[]{this.location[0], this.location[1]};
    }
    ...
    public float[] getScaleArray() {
        return new float[]{this.scale[0], this.scale[1]};
    }
    ...
    public float[] getScaleRateArray() {
        return new float[]{this.scaleRate[0], this.scaleRate[1]};
    }
