...
public final class CombatRenderingManager {
     ...
     */
    public static boolean addStaticTrailGenerator(@NotNull final StaticTrailData trailData, @Nullable final CombatEntityAPI linkedEntity, @NotNull final CombatEngineLayers layer, @NotNull final StaticTrailTracker tacker) {
     ...
     */
    public void tryCutTrailOnEntity(@NotNull final CombatEntityAPI linkedEntity) {
