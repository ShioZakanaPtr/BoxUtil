...
public final class CampaignRenderingManager {
    ...
    public static byte addEntity(byte target, @NotNull RenderDataAPI entity) {
        return BUtil_ResourceStorage.campaignLayered().addEntity(entity);
    }
    ...
    public static boolean containsEntity(CampaignEngineLayers layer, byte target, RenderDataAPI entity) {
        return BUtil_ResourceStorage.campaignLayered().containsEntity(layer, entity);
    }
    ...
    public static boolean removeEntity(RenderDataAPI entity) {
        return BUtil_ResourceStorage.campaignLayered().removeEntity(entity);
    }
     ...
     */
    public static boolean addStaticTrail(@NotNull final StaticTrailData trailData, @Nullable final SectorEntityToken linkedEntity, @NotNull final CampaignEngineLayers layer, @NotNull final StaticTrailTracker tacker) {
        return BUtil_ResourceStorage.campaignLayered().addStaticTrailTracker(trailData, linkedEntity, layer, BUtil_StaticTrailMemoryPool.toLayerLoc(layer), tacker);
    }
     ...
     */
    public static void tryCutTrailOnEntity(@NotNull final SectorEntityToken linkedEntity) {
     ...
     */
    public static void tryRemoveTrailOnEntity(@NotNull final SectorEntityToken linkedEntity, boolean isImmediate) {
    ...
    public static boolean removeStaticTrail(@NotNull final StaticTrailData trailData) {
        return BUtil_StaticTrailMemoryPool.removeTracker(trailData, true);
    }
    ...
    public static void addRenderingPlugin(@NotNull LayeredRenderingPlugin plugin) {
        BUtil_ResourceStorage.campaignLayered().addRenderingPlugin(plugin, plugin.getCampaignActiveLayers());
    }

    public static boolean containsRenderingPlugin(CampaignEngineLayers layer, LayeredRenderingPlugin plugin) {
        return BUtil_ResourceStorage.campaignLayered().containsRenderingPlugin(layer, plugin);
    }

    public static boolean containsRenderingPlugin(LayeredRenderingPlugin plugin) {
        return BUtil_ResourceStorage.campaignLayered().containsRenderingPlugin(plugin);
    }
    ...
    public static void addCleanupPlugin(@NotNull TemporaryCleanupPlugin plugin) {
        BUtil_ResourceStorage.campaignLayered().addCleanupPlugin(plugin);
    }

    public static boolean containsCleanupPlugin(TemporaryCleanupPlugin plugin) {
        return BUtil_ResourceStorage.campaignLayered().containsCleanupPlugin(plugin);
    }
