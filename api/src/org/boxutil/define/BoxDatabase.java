...
//            this.GL_TEXTURE_STORAGE = cap.GL_ARB_texture_storage && cap.OpenGL42;
            ...
            this.MAX_TEXTURE_BUFFER_SIZE = cap.OpenGL31 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Buffer.TBO.GL_MAX_TEXTURE_BUFFER_SIZE) : 0;
            this.MAX_UNIFORM_BLOCK_SIZE = cap.OpenGL31 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Buffer.UBO.GL_MAX_UNIFORM_BLOCK_SIZE) : 0;
            this.MAX_SHADER_STORAGE_BLOCK_SIZE = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger64(GLWrapper.Buffer.SSBO.GL_MAX_SHADER_STORAGE_BLOCK_SIZE) : 0;
            this.MAX_SHADER_STORAGE_BUFFER_BINDINGS = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GL43.GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS) : 0;
            this.MAX_VERTEX_SHADER_STORAGE_BLOCKS = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GL43.GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS) : 0;
            this.MAX_TEXTURE_SIZE = GLWrapper.Operation.Get.glGetInteger(GLWrapper.Texture.GL_MAX_TEXTURE_SIZE);
            this.MAX_TEXTURE2D_PIXELS = ((long) this.MAX_TEXTURE_SIZE) * ((long) this.MAX_TEXTURE_SIZE);
            this.MAX_TEXTURE3D_SIZE = cap.OpenGL12 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Texture.GL_MAX_3D_TEXTURE_SIZE) : 0;
            this.MAX_TEXTURE3D_PIXELS = ((long) this.MAX_TEXTURE3D_SIZE) * ((long) this.MAX_TEXTURE3D_SIZE) * ((long) this.MAX_TEXTURE3D_SIZE);
            this.MAX_TEXTURE_UNITS = cap.OpenGL20 ? GLWrapper.Operation.Get.glGetInteger(GL20.GL_MAX_TEXTURE_IMAGE_UNITS) : 0;
            this.MAX_IMAGE_UNITS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_IMAGE_UNITS) : 0;
            this.MAX_VERTEX_IMAGE_UNIFORMS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_VERTEX_IMAGE_UNIFORMS) : 0;
            this.MAX_TESS_CONTROL_IMAGE_UNIFORMS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS) : 0;
            this.MAX_TESS_EVALUATION_IMAGE_UNIFORMS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS) : 0;
            this.MAX_GEOMETRY_IMAGE_UNIFORMS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_GEOMETRY_IMAGE_UNIFORMS) : 0;
            this.MAX_FRAGMENT_IMAGE_UNIFORMS = cap.OpenGL42 ? GLWrapper.Operation.Get.glGetInteger(GL42.GL_MAX_FRAGMENT_IMAGE_UNIFORMS) : 0;
            this.MAX_COMPUTE_IMAGE_UNIFORMS = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GL43.GL_MAX_COMPUTE_IMAGE_UNIFORMS) : 0;
            this.GL_MAX_WORK_GROUP_SIZE_X = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger64(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_COUNT, 0) : 0;
            this.GL_MAX_WORK_GROUP_SIZE_Y = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger64(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_COUNT, 1) : 0;
            this.GL_MAX_WORK_GROUP_SIZE_Z = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger64(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_COUNT, 2) : 0;
            this.GL_MAX_LOCAL_SIZE_X = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_SIZE, 0) : 0;
            this.GL_MAX_LOCAL_SIZE_Y = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_SIZE, 1) : 0;
            this.GL_MAX_LOCAL_SIZE_Z = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_SIZE, 2) : 0;
            this.GL_MAX_WORK_ITEMS = cap.OpenGL43 ? GLWrapper.Operation.Get.glGetInteger(GLWrapper.Shader.Comp.GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS) : 0;
